# Source & Conflict Log — Phases 7A/7B/7B.1 (updated 2026-08-03)

| # | Claim | Source 1 | Source 2 | Conflict | Resolution | Remaining uncertainty |
|---|---|---|---|---|---|---|
| 1 | Alex Golesh's destination | Garbled CBS carousel snippet ("Cal: Golesh") | ESPN + Fox News: Auburn hired Golesh | Direct contradiction | ESPN/Fox direct reporting wins: **Auburn** | Cal's actual 2026 hire (unverified) |
| 2 | UNLV "MWC favorite" (7A claim) | On3 G6 preview (favored) | SportsBettingDime/CFN: +240 | Favorite vs co-favorite | Market price wins: **co-favorite** — 7A claim corrected | Identity of the co-favorite(s) |
| 3 | Texas Tech QB risk framing | July exception tracker (unresolved injury; checkpoint 8/21) | On3/ESPN late July: surgeon fully cleared; Week 1 if formally cleared | Stale vs current | Newer, more specific reporting wins; **deferral retained** to the formal ~8/21 clearance | First-year-back performance level |
| 4 | Ole Miss roster framing (7A: "heavy churn") | 7A audit note | SI/Rebel Walk camp coverage: Chambliss settled, Knight backup, Sanders back, No. 2 portal | Churn vs strong core | Camp coverage wins: **core is strong**; downgrade case narrowed to play-calling transition | Who calls the offense under Golding (open trigger) |
| 5 | Alabama QB leader | Athlon/CBS: Russell "leader in clubhouse" | DeBoer (7/22): deliberately murky, extends into camp | Leader vs open | Coach's own statement wins: **open competition** | Naming date |
| 6 | Florida QB frontrunner | Tampa Bay Times (Jan): Philo potential starter | CBS post-spring intel: Jones Jr. frontrunner | Different frontrunners | Newer post-spring intel wins, weakly held | Genuine two-man (possibly three-man) race into camp |
| 7 | Vanderbilt QB status | Phase 8.3 verification (Lea, SEC Media Days 7/21: open) | Phase 7B sweep: no naming found | None — consistent | Battle confirmed open | Winner; timing (may extend to opener) |
| 8 | FAU upgrade case | Connelly RP top-20 (only G6 team) | Market win total ~5.5; SP+ (RP-aware) already FAU's best source | Bull case vs market | **RP is an input to SP+ → already priced**; market corroborates current rating | Whether Veltkamp's play elevates FAU anyway |
| 9 | UTSA level | SP+ −1.5 / TR −1.5 | FPI −5.3 | 3.8-pt outlier gap | Unresolved *why*; owner standard: disagreement alone ≠ override → **hold** | Cause of FPI's lower view |
