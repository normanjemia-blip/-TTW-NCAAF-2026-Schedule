...
|---|---|---|:--:|
| **1 — ARCHIVE** | **current:** `TTW_College_Football_Power_Ratings_v0.8.9_AUTHORITATIVE.xlsx` · SHA-256 `33405066…5cbb`<br>**frozen:** `…v0.8.8…` · `b2a920fe…6450`<br>**frozen:** `…v0.8.7…` · `46671dee…15cd`<br>**frozen:** `…v0.8.6…` · `bb76901a…67f9`<br>**frozen:** `…v0.8.5…` · `0676aa1a…67be`<br>**frozen:** `…v0.8.4…` · `ed5d3b3d…a892`<br>**frozen:** `…v0.8.3…` · `ff557825…96b8`<br>**frozen:** `…v0.8.2…` · `22508544…90d0`<br>**frozen predecessor:** `…v0.8.1_AUTHORITATIVE.xlsx` · SHA-256 `e2da9a4c…cdfd6` | Immutable reference of record | **Never** |
