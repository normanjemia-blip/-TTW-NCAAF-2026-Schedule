...
|---|---|---|:--:|
| **1 — ARCHIVE** | **current:** `TTW_College_Football_Power_Ratings_v0.8.3_AUTHORITATIVE.xlsx` · SHA-256 `ff557825…96b8`<br>**frozen:** `…v0.8.2…` · `22508544…90d0`<br>**frozen predecessor:** `…v0.8.1_AUTHORITATIVE.xlsx` · SHA-256 `e2da9a4c…cdfd6` | Immutable reference of record | **Never** |
...
1. Confirm the archive is intact: current v0.8.3 SHA-256 must be `ff55782586ef1adb662eba59710e824dc382769a24579e48917b101fbcdd96b8`; the frozen v0.8.2 predecessor must remain `225085449b5a1db5903a3998cb909be1f7ae0037782ea65d412bcb4d9d9490d0`; the frozen v0.8.1 predecessor must remain `e2da9a4c28bd5c0f094ab06a2a85d3e31b37c2aba894f97f3415e15f799cdfd6`
