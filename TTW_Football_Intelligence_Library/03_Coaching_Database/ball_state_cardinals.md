...
# Ball State Cardinals — Coaching Intelligence

> **Source: 2026 VSiN College Football Betting Guide.** Team pages pp. 218–219; Stability Score table p. 42. GUIDE CONTENT throughout. No outside research, and no post-publication updates: this record states the guide's position at publication and nothing later.

## Program and staff

| # | Field | Value |
| --- | --- | --- |
| 1 | Team | Ball State Cardinals |
| 2 | Conference | MAC |
...
- Team file: [../02_Team_Database/ball_state_cardinals.md](../02_Team_Database/ball_state_cardinals.md)
- Quarterback file: [../04_Quarterback_Database/ball_state_cardinals.md](../04_Quarterback_Database/ball_state_cardinals.md)
