...
# Paul Howard — every futures position in the guide
...
## Season predictions (p. 4) — 17 picks
...
| MWC CCHAMPION | New Mexico |
| PAC-12 CHAMPION | Boise State |
| SUN BELT CHAMPION | James Madison |
| CFP FINAL FOUR #1 | Notre Dame |
| CFP FINAL FOUR #2 | Oregon |
| CFP FINAL FOUR #3 | Georgia |
| CFP FINAL FOUR #4 | Texas Tech |
| CFP TITLE GAME #1 | Notre Dame |
| CFP TITLE GAME #2 | Georgia |
| CFP CHAMPION | Notre Dame |

## Best bets (pp. 5–15)

Paul Howard does not appear in the best-bets feature.

## Cross-links

- [All best bets](00_BEST_BETS.md) · [prediction grid](00_PREDICTIONS.md) · [contributor disagreement](00_DISAGREEMENT.md)
