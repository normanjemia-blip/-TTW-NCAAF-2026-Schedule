...
# Kansas Jayhawks — Quarterback Intelligence

> **Two layers, never merged.** Section A is what the VSiN guide said at publication (pp. 132–133). Section B is the independently verified current state from the TTW Power Ratings QB verification project. Nothing in Section B is VSiN's opinion; nothing in Section A is a current fact.
...
Team file: [../02_Team_Database/kansas_jayhawks.md](../02_Team_Database/kansas_jayhawks.md)
...
- Evidence: VERIFIED 2026-08-03: Cole Ballard 'MAY BE' Kansas's QB1 (SI headline wording) replacing Jalon Daniels, with real competition from Isaiah Marshall - Ballard the better thrower, Marshall the better runner; Kansas QBs described as 'totally fine with competition heading into camp.' Ballard confirmed on the official kuathletics.com roster. No naming by Lance Leipold located -> L retained. This confirms the Phase 7D.3 decision NOT to upgrade on a national projected-starter list alone. Values remain blank; UNCERTAIN.
