...
# UNLV Rebels — Quarterback Intelligence

> **Two layers, never merged.** Section A is what the VSiN guide said at publication (pp. 258–259). Section B is the independently verified current state from the TTW Power Ratings QB verification project. Nothing in Section B is VSiN's opinion; nothing in Section A is a current fact.
...
**Returning-QB marker on the team spread (p. 258):** absent — the guide does not mark this team as returning its quarterback. Printed offensive returning starters: 3.

Team file: [../02_Team_Database/unlv_rebels.md](../02_Team_Database/unlv_rebels.md)
...
| Field | Value |
| --- | --- |
| Workbook team | UNLV (`UNLV`, QB VALUES row 125) |
| Currently verified expected starter | Open (Jackson Arnold / Alex Orji) |
| Baseline QB | Jackson Arnold |
...
- Source: ESPN (Arnold to UNLV) (https://www.espn.com/college-football/story/_/id/47539823/qb-jackson-arnold-headed-unlv-third-team-three-seasons)
- Evidence: DEFECT CORRECTED 7D.5 2026-08-04: prior entry read 'projected transfer QB1 (verified)' (M) for the Oklahoma/Auburn transfer. The Las Vegas Review-Journal's training-camp preview (2026-07-28) reports a genuine unresolved battle: 'even if coaches won't name a front-runner throughout training camp, there is definitely a battle between returner ALEX ORJI and Auburn transfer JACKSON ARNOLD.' HC Dan Mullen has NOT named a starter, and Fox5 Vegas (2026-07-17) ran a segment on the still-open competition. Arnold brings 18 career starts, 3,293 pass yds and 871 rush yds across Oklahoma and Auburn; Orji must prove a Grade 3 LCL sprain and severe hamstring tear from the 2025 UCLA game have healed. The word 'verified' in the prior note was not supported by any naming. -> M downgraded to L; zeros CLEARED to blank; status becomes UNCERTAIN. Someone must start vs Memphis on 2026-08-29. RECHECK: UNLV depth chart.
