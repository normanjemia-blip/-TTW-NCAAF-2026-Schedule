...
# Temple Owls — Quarterback Intelligence

> **Two layers, never merged.** Section A is what the VSiN guide said at publication (pp. 68–69). Section B is the independently verified current state from the TTW Power Ratings QB verification project. Nothing in Section B is VSiN's opinion; nothing in Section A is a current fact.
...
Team file: [../02_Team_Database/temple_owls.md](../02_Team_Database/temple_owls.md)
...
| Field | Value |
| --- | --- |
| Workbook team | Temple (`TEM`, QB VALUES row 90) |
| Currently verified expected starter | Jaxon Smolik (inside track; Ajani Sheppard competing) |
| Baseline QB | Jaxon Smolik |
...
- Evidence: VERIFIED 2026-08-03: Temple's spring battle was between transfers Jaxon Smolik (Penn State) and Ajani Sheppard (Washington State), with SMOLIK OWNING THE INSIDE TRACK. Clear leader with competition -> M retained; entry refined.
