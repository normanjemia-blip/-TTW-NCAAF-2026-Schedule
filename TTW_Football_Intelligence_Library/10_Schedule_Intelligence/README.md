# 10 Schedule Intelligence

**Status:** Not yet built — **No phase assigned** — see [13 — Open Questions and Gaps](../00_Master_Index/13_Open_Questions_And_Gaps.md), item 3

## Scope

Schedules with projected lines and opponent ratings; trap games, rest advantages, scheduling edges.

## Source pages

Every team's left-hand page schedule table
